...
const Home: NextPage = (): JSX.Element => {
    ...
    <div className='flex justify-center items-center h-screen'>
        ...
        <div className='flex bg-white shadow-2xl md:h-80 min-w-min md:w-4/12 max-w-3xl flex-col w-6/12 md:flex-row overflow-hidden'>
                ...
                <div className='text-center p-8'>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className='grid grid-row gap-2 mt-4'>                            
                            <div className="bg-gray-100 p-2 md:w-full flex">
                    ...
                    <div className='mt-4'>
                    <p className="text-blueGray-400">Don't have account contact us at <span className="text-slate-800 font-bold mt-1 block">care.bytesec@gmail.com</span></p>
                    </div>
                </div>
